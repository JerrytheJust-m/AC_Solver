"""
This file contains agents class that implements actor and critic networks.

The new addition incorporates randomness in the agent's actions, which is essential
in the research sibling methods. Other methods initializes randomness = 1.
"""

#TODO: use original file, this one is dismantled
...
class Agent(nn.Module):
    ...
    def __init__(self, envs, nodes_counts):
        """
        Initializes the agents with specified environment and node counts for the neural networks.
        ...
        randomness (np.float32 in (0, 1)): In research sibling method, randomness in the research is determined externally
        """
        super().__init__()
